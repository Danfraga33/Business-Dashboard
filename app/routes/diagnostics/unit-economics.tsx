    ...
    return (
      <div className="space-y-8">
        <div className="animate-in">
          <h2 className="font-serif text-3xl font-semibold text-foreground">Unit Economics</h2>
    ...
    <div className="space-y-8">
      ...
      <div className="card animate-in stagger-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
          ...
          <div>
            <h4 className="text-base font-semibold text-foreground mb-4">Expansion vs. Contraction</h4>
            <div className="space-y-3">
              <div className="flex items-center justify-between p-3 rounded-lg bg-success/5 border border-success/20">
                <div className="flex items-center gap-2">
                  <ArrowUpRight className="w-4 h-4 text-success" />
                  <span className="text-base text-foreground">Expansion MRR</span>
                </div>
              ...
              <div className="flex items-center justify-between p-3 rounded-lg bg-danger/5 border border-danger/20">
                <div className="flex items-center gap-2">
                  ...
                  <span className="text-base text-foreground">Contraction MRR</span>
                </div>
              ...
              <div className="flex items-center justify-between p-3 rounded-lg bg-primary/5 border border-primary/20">
                <span className="text-base font-semibold text-foreground">Net Expansion</span>
          ...
          <div>
            <h4 className="text-base font-semibold text-foreground mb-4">Complete Breakdown</h4>
            <div className="space-y-2">
              {mrrMovement.map((item) => (
                <div key={item.name} className="flex items-center justify-between py-2 border-b border-border/50">
                  ...
                  <span className={`text-base font-mono ${item.value >= 0 ? "text-success" : "text-danger"}`}>
                    {item.value >= 0 ? "+" : ""}{formatCurrency(item.value)}
                  </span>
                </div>
              ))}
              <div className="flex items-center justify-between pt-3 border-t-2 border-border">
                <span className="text-base font-semibold text-foreground">Net New MRR</span>
                <span className={`text-base font-mono font-bold ${netNewMRR >= 0 ? "text-success" : "text-danger"}`}>
