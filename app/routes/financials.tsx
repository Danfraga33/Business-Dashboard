...
export default function Financials() {
    ...
    return (
      <div className="space-y-8">
        <div className="animate-in">
          <h2 className="text-3xl font-semibold text-foreground font-serif">Financials</h2>
  ...
  return (
    <div className="space-y-8">
      {/* Header */}
      <div className="animate-in">
        <h2 className="text-3xl font-semibold text-foreground leading-tight font-serif">Financials</h2>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <div className="card animate-in">
          <h3 className="font-semibold text-foreground mb-5 flex items-center gap-2 font-serif">
            ...
            <span className="text-[13px] text-muted-foreground font-normal font-sans ml-auto">Monthly</span>
          </h3>
          ...
          <div className="space-y-4">
            ...
            <div>
              <div className="flex items-center justify-between py-2.5 border-b border-border">
                <span className="text-base font-semibold text-foreground">Revenue</span>
              ...
              <div className="flex items-center justify-between py-1.5 pl-4">
                <span className="text-[15px] text-muted-foreground">Annual Run Rate</span>
                <span className="text-[15px] font-mono text-secondary-foreground">
            ...
            <div>
              <div className="flex items-center justify-between py-2.5 border-b border-border">
                <span className="text-base font-semibold text-foreground">Cost of Goods Sold</span>
                <span className="text-base font-mono font-semibold text-danger">
                  ({formatCurrency(pnlData.cogs.total)})
                </span>
              </div>
              <div className="flex items-center justify-between py-1.5 pl-4">
                <span className="text-[15px] text-muted-foreground">Hosting & Infrastructure</span>
                <span className="text-[15px] font-mono text-secondary-foreground">
                  ({formatCurrency(pnlData.cogs.hosting + pnlData.cogs.infrastructure)})
                </span>
              </div>
              <div className="flex items-center justify-between py-1.5 pl-4">
                <span className="text-[15px] text-muted-foreground">Third-party APIs</span>
                <span className="text-[15px] font-mono text-secondary-foreground">
                  ({formatCurrency(pnlData.cogs.thirdPartyApis)})
                </span>
              </div>
              <div className="flex items-center justify-between py-1.5 pl-4">
                <span className="text-[15px] text-muted-foreground">Customer Support Tools</span>
                <span className="text-[15px] font-mono text-secondary-foreground">
            ...
            <div>
              <div className="flex items-center justify-between py-2.5 border-b border-border">
                <span className="text-base font-semibold text-foreground">Operating Expenses</span>
                <span className="text-base font-mono font-semibold text-danger">
                  ({formatCurrency(pnlData.opex.total)})
                </span>
              </div>
              <div className="flex items-center justify-between py-1.5 pl-4">
                <span className="text-[15px] text-muted-foreground">Marketing & Ads</span>
                <span className="text-[15px] font-mono text-secondary-foreground">
                  ({formatCurrency(pnlData.opex.marketing)})
                </span>
              </div>
              <div className="flex items-center justify-between py-1.5 pl-4">
                <span className="text-[15px] text-muted-foreground">SaaS Tools & Software</span>
                <span className="text-[15px] font-mono text-secondary-foreground">
                  ({formatCurrency(pnlData.opex.tools)})
                </span>
              </div>
              <div className="flex items-center justify-between py-1.5 pl-4">
                <span className="text-[15px] text-muted-foreground">Legal & Compliance</span>
                <span className="text-[15px] font-mono text-secondary-foreground">
                  ({formatCurrency(pnlData.opex.legal)})
                </span>
              </div>
              <div className="flex items-center justify-between py-1.5 pl-4">
                <span className="text-[15px] text-muted-foreground">Miscellaneous</span>
                <span className="text-[15px] font-mono text-secondary-foreground">
            ...
            <div className="flex items-center justify-between py-2.5 border-y-2 border-border bg-muted/50 px-2 -mx-2 rounded">
              <span className="text-base font-bold text-foreground">Net Income (EBITDA)</span>
              <div className="text-right">
                <span className={`text-base font-mono font-bold ${pnlData.ebitda >= 0 ? "text-success" : "text-danger"}`}>
        ...
        <div className="card animate-in border-chart-4/20">
          <div className="flex items-center gap-2.5 mb-5">
            ...
            <span className="ml-auto px-2.5 py-0.5 rounded-full text-[13px] font-semibold uppercase tracking-wider bg-chart-4/10 text-chart-4">
              Beta
            </span>
          </div>
          ...
          <div className="space-y-4 max-h-[600px] overflow-y-auto pr-2">
            ...
            <div className="p-3.5 rounded-lg bg-muted/50 border border-border/50">
              <div className="flex items-start gap-2 mb-2">
                ...
                <div>
                  <h4 className="text-[15px] font-semibold text-foreground mb-1">Health Assessment</h4>
            ...
            <div className="space-y-2">
              <h4 className="text-[15px] font-semibold text-foreground">Margin Analysis</h4>
              <div className="grid grid-cols-2 gap-3">
                <div className="p-3 rounded-lg bg-muted/50 border border-border/50">
                  <p className="text-[13px] text-muted-foreground mb-1">Gross Margin</p>
                  ...
                  <p className="text-[13px] text-muted-foreground mt-1">{aiAnalysis.marginAnalysis.grossMargin.message}</p>
                </div>
                <div className="p-3 rounded-lg bg-muted/50 border border-border/50">
                  <p className="text-[13px] text-muted-foreground mb-1">Net Margin</p>
                  <span className={`text-2xl font-bold font-mono ${
                  ...
                  <p className="text-[13px] text-muted-foreground mt-1">{aiAnalysis.marginAnalysis.netMargin.message}</p>
                </div>
              </div>
            </div>
            ...
            {/* Cost Structure */}
            <div className="p-3.5 rounded-lg bg-muted/50 border border-border/50">
              <h4 className="text-[15px] font-semibold text-foreground mb-2">Cost Structure</h4>
              <div className="space-y-2 text-[15px] text-secondary-foreground leading-relaxed">
            ...
            <div className="p-3.5 rounded-lg bg-muted/50 border border-border/50">
              <div className="flex items-center gap-2 mb-2">
                <span className="px-1.5 py-0.5 rounded bg-primary/10 text-primary text-[13px] font-bold font-mono">Q1</span>
                <h4 className="text-[15px] font-semibold text-foreground">Quick Wins</h4>
              </div>
              <ul className="space-y-1.5 text-[15px] text-secondary-foreground">
            ...
            <div className="p-3.5 rounded-lg bg-muted/50 border border-border/50">
              <div className="flex items-center gap-2 mb-2">
                <span className="px-1.5 py-0.5 rounded bg-success/10 text-success text-[13px] font-bold font-mono">Q2-Q3</span>
                <h4 className="text-[15px] font-semibold text-foreground">Structural</h4>
              </div>
              <ul className="space-y-1.5 text-[15px] text-secondary-foreground">
            ...
            <div className="p-3.5 rounded-lg bg-muted/50 border border-border/50">
              <div className="flex items-center gap-2 mb-2">
                <span className="px-1.5 py-0.5 rounded bg-chart-4/10 text-chart-4 text-[13px] font-bold font-mono">Q4+</span>
                <h4 className="text-[15px] font-semibold text-foreground">Scale</h4>
              </div>
              <ul className="space-y-1.5 text-[15px] text-secondary-foreground">
            ...
            {/* Key Metrics */}
            <div className="p-3.5 rounded-lg bg-muted/50 border border-border/50">
              <h4 className="text-[15px] font-semibold text-foreground mb-2">Track These</h4>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        <div className="card animate-in stagger-1">
          <div className="flex items-center gap-2 mb-3">
            ...
            <p className="text-[15px] font-medium text-muted-foreground uppercase tracking-wider">Monthly Burn Rate</p>
          </div>
          <div className="flex items-baseline gap-2">
            <span className="text-3xl font-bold text-danger font-mono">
        ...
        <div className="card animate-in stagger-1">
          <div className="flex items-center gap-2 mb-3">
            ...
            <p className="text-[15px] font-medium text-muted-foreground uppercase tracking-wider">Runway</p>
          </div>
          <div className="flex items-baseline gap-2">
            <span className={`text-3xl font-bold font-mono ${runway > 6 ? "text-success" : runway > 3 ? "text-warning" : "text-danger"}`}>
              {runway === Infinity ? "∞" : runway.toFixed(1)}
            </span>
            {runway !== Infinity && <span className="text-base text-muted-foreground">months</span>}
          </div>
          <p className="text-[13px] text-muted-foreground mt-2">
        ...
        <div className="card animate-in stagger-2 border-primary/20">
          <p className="text-[15px] font-semibold text-foreground mb-3">Unit Economics</p>
          <div className="space-y-2.5">
            <div className="flex items-center justify-between">
              <span className="text-[13px] text-muted-foreground">ARPU</span>
              <span className="text-[15px] font-mono text-foreground">{formatCurrency(monthlyRevenue / 12)}</span>
            </div>
            <div className="flex items-center justify-between">
              <span className="text-[13px] text-muted-foreground">CAC</span>
              <span className="text-[15px] font-mono text-foreground">{formatCurrency(latest.cac)}</span>
            </div>
            <div className="flex items-center justify-between">
              <span className="text-[13px] text-muted-foreground">LTV</span>
              <span className="text-[15px] font-mono text-foreground">{formatCurrency(latest.ltv)}</span>
            </div>
            <div className="flex items-center justify-between pt-2.5 border-t border-primary/20">
              <span className="text-[13px] font-semibold text-foreground">LTV:CAC</span>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
        <div className="card animate-in stagger-3">
          <div className="flex items-center gap-2 mb-3">
            ...
            <p className="text-[15px] font-medium text-muted-foreground uppercase tracking-wider">LTV:CAC Ratio</p>
          </div>
          <div className="flex items-baseline gap-2">
            <HealthIndicator value={latest.ltv_cac_ratio} thresholds={{ good: 3, warning: 2 }} />
            <span className="text-[15px] text-muted-foreground">:1</span>
          </div>
          <p className="text-[13px] text-muted-foreground mt-2">Target: 3:1 or higher</p>
        </div>
        ...
        <div className="card animate-in stagger-3">
          <div className="flex items-center gap-2 mb-3">
            ...
            <p className="text-[15px] font-medium text-muted-foreground uppercase tracking-wider">Payback Period</p>
          </div>
          <div className="flex items-baseline gap-2">
          ...
          <p className="text-[13px] text-muted-foreground mt-2">Target: &lt;12 months</p>
        </div>
        ...
        <div className="card animate-in stagger-4">
          <div className="flex items-center gap-2 mb-3">
            ...
            <p className="text-[15px] font-medium text-muted-foreground uppercase tracking-wider">Gross Margin</p>
          </div>
          <div className="flex items-baseline gap-2">
            <HealthIndicator value={latest.gross_margin} thresholds={{ good: 70, warning: 50 }} />
            <span className="text-[15px] text-muted-foreground">%</span>
          </div>
          <p className="text-[13px] text-muted-foreground mt-2">Target: &gt;70%</p>
        </div>
        ...
        <div className="card animate-in stagger-4">
          <div className="flex items-center gap-2 mb-3">
            ...
            <p className="text-[15px] font-medium text-muted-foreground uppercase tracking-wider">Net Revenue Retention</p>
          </div>
          <div className="flex items-baseline gap-2">
            <HealthIndicator value={latest.nrr} thresholds={{ good: 110, warning: 100 }} />
            <span className="text-[15px] text-muted-foreground">%</span>
          </div>
          <p className="text-[13px] text-muted-foreground mt-2">Target: &gt;110%</p>
        </div>
      </div>

      {/* CAC vs LTV Chart */}
      <div className="card animate-in stagger-5">
        <h3 className="text-lg font-semibold text-foreground mb-6 flex items-center gap-2 font-serif">
          <DollarSign className="w-4 h-4 text-warning" />
          CAC vs LTV
          <span className="text-[13px] text-muted-foreground font-normal font-sans ml-auto">Last 90 days</span>
        </h3>
      ...
      {serviceSummary.length > 0 && (
        <div className="card animate-in stagger-6">
          <h3 className="text-lg font-semibold text-foreground mb-6 flex items-center gap-2 font-serif">
            ...
            <span className="text-[13px] text-muted-foreground font-normal font-sans ml-auto">Last 30 days</span>
          </h3>
            ...
            <table className="w-full">
              ...
              <tbody>
                ...
                <tr className="border-t-2 border-border">
                  <td className="py-2.5 pr-4 text-base font-semibold text-foreground">Total</td>
                  <td className="py-2.5 px-4 text-base font-mono font-semibold text-right text-foreground">
