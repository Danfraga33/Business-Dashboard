...
function SeverityBadge({ severity }: { severity: "critical" | "warning" }) {
  return (
    <span
      className={`inline-flex items-center gap-1 px-2 py-0.5 rounded-full text-[13px] font-semibold uppercase tracking-wider ${
        severity === "critical"
...
function PriorityBadge({ priority }: { priority: "high" | "medium" | "low" }) {
  ...
  return (
    <span
      className={`inline-flex items-center px-2 py-0.5 rounded-full text-[13px] font-semibold uppercase tracking-wider ${colors[priority]}`}
    >
      {priority}
    </span>
  );
  ...
  return (
    <div className="space-y-8">
      ...
      <div className="animate-in">
        <h2 className="text-3xl font-semibold text-foreground leading-tight font-serif">
          {briefing.greeting}
        </h2>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <div className="card animate-in stagger-2">
          <div className="flex items-center gap-2.5 mb-5">
            ...
            <span className="ml-auto text-[15px] font-mono text-danger bg-danger/10 px-2 py-0.5 rounded-full">
              ...
              <ExpandableItem key={i} detail={opp.detail}>
                <div className="flex items-start gap-2.5">
                  ...
                  <div>
                    ...
                    <p className="text-[15px] font-mono text-success/80 mt-1">
                      {opp.impact}
                    </p>
                  </div>
                </div>
      ...
      <div className="card animate-in stagger-5">
        ...
        <div className="space-y-4">
          {briefing.recommendedActions.map((action, i) => (
            ...
            >
              <div className="flex items-center justify-center w-7 h-7 rounded-full bg-primary/10 text-primary text-base font-bold font-mono shrink-0">
                {i + 1}
              </div>
